...
class Tab1:
    def __init__(self, master):
        ...
        self.checkbox1 = tk.Checkbutton(self.frame, text="Download images", variable=self.downloadImg,
                                        onvalue=1, offvalue=0)
        self.checkbox1.grid_remove()

        # store data in file checkbox
        self.checkVariable = tk.IntVar(self.frame)
        self.checkbox2 = tk.Checkbutton(self.frame, text="Store data in text file", variable=self.checkVariable,
                                        onvalue=1, offvalue=0)
